...
Ans: i) var is old way to declare variables, can be redeclared and updated.
ii)let is Modern variable, can be updated but not redeclared in the same scope.
iii)const is Cannot be updated or redeclared, value stays constant.
